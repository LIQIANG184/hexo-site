最近的项目中涉及到了将zip文件从服务上下载下来，然后解压使用。搜索了一下发现有一个压缩与解压zip文件的第三方“SSZipArchive”：[https://github.com/ZipArchive/ZipArchive](https://link.jianshu.com?t=https://github.com/ZipArchive/ZipArchive) 是用C语言实现的，包装用于OC与swift.
<!-- more -->
##### 一、在使用过程中遇到过几个坑：
...
2.  我每一次下载的文件样式都是一样的，所以希望覆盖式的解压，一开始没有注意以为它只有解压方法：+ (BOOL)unzipFileAtPath:(NSString *)path toDestination:(NSString *)destination;
    ...
    [http://blog.csdn.net/zhengang007/article/details/51019479](https://link.jianshu.com?t=http://blog.csdn.net/zhengang007/article/details/51019479)
    这里有每一个方法的详细说明。
...
作者：gavincarter
链接：https://www.jianshu.com/p/e69d77d97a5e
來源：简书
